...
@section('admin-content')
    <div id="content" class="content">
        ...
        <!-- end breadcrumb -->
        <!-- begin page-header -->
        <h1 class="page-header">入库列表 <small>header small text goes here...</small></h1>
        <!-- end page-header -->
        <!-- begin row -->
        <div class="row">
            <!-- begin col-6 -->
                        ...
                        <table class="table table-bordered table-hover" id="datatable">
                            ...
                            <tr>
                                ...
                                <th>
                                    @if($value['status'] == 1)
                                        <a>
                                            <button type='button' class='btn btn-default btn-xs'><i class='fa fa-pencil'>上架</i></button></a>

                                    @else
                                        <a href='./inbound/{{$value['id']}}/edit'>
                                            <button type='button' class='btn btn-success btn-xs'><i class='fa fa-pencil'> 上架</i></button></a>
                                    @endif
